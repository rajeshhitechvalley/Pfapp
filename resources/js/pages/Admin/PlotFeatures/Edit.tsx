...
interface EditPlotFeaturesProps {
    plot: {
        id: number;
        property_id: number;
        plot_number: string;
...
export default function EditPlotFeatures({ 
    plot, 
    properties, 
    plotTypes, 
    areaUnits, 
    facingDirections, 
    statuses 
}: EditPlotFeaturesProps) {
    const { data, setData, post, processing, errors } = useForm({
        property_id: plot.property_id?.toString() || '',
        ...
        road_facing: plot.road_facing || false,
        status: plot.status || 'available',
        description: plot.description || '',
        features: plot.features || [],
        dimensions: plot.dimensions || '',
        length: plot.length?.toString() || '',
        width: plot.width?.toString() || '',
        location_details: plot.location_details || '',
        facing_direction: plot.facing_direction || '',
        road_width: plot.road_width?.toString() || '',
        corner_plot: plot.corner_plot || false,
        double_road: plot.double_road || false,
        location_coordinates: plot.location_coordinates || '',
        nearby_amenities: plot.nearby_amenities || [],
        soil_type: plot.soil_type || '',
        topography: plot.topography || '',
        legal_clearance: plot.legal_clearance || '',
        development_charges: plot.development_charges?.toString() || '',
        maintenance_charges: plot.maintenance_charges?.toString() || '',
        water_connection: plot.water_connection || false,
        electricity_connection: plot.electricity_connection || false,
        sewage_connection: plot.sewage_connection || false,
        gas_connection: plot.gas_connection || false,
        internet_connection: plot.internet_connection || false,
        road_access: plot.road_access || '',
        tags: plot.tags || [],
        priority_level: plot.priority_level?.toString() || '1',
        featured_plot: plot.featured_plot || false,
        original_price: plot.original_price?.toString() || '',
        discount_percentage: plot.discount_percentage?.toString() || '',
        special_offer: plot.special_offer || false,
        offer_expiry_date: plot.offer_expiry_date || '',
        negotiable: plot.negotiable || false,
    });
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post(`/admin/plots/features/${plot.id}`, submissionData);
    };

    return (
        <AdminLayout>
            <Head title={`Edit Plot: ${plot.plot_number}`} />
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900">Edit Plot: {plot.plot_number}</h1>
                        <p className="text-gray-600">Update plot information</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                            ...
                            <label className="flex items-center gap-2">
                                ...
                                <span className="text-sm text-gray-900">Road Access</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-end gap-4">
                        ...
                        >
                            ...
                            {processing ? 'Updating...' : 'Update Plot'}
                        </button>
                    </div>
                </form>
            </div>
